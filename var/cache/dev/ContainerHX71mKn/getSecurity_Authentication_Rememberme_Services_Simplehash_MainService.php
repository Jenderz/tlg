...
return $this->privates['security.authentication.rememberme.services.simplehash.main'] = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => ($this->privates['security.user.provider.concrete.db_provider'] ?? $this->load(__DIR__.'/getSecurity_User_Provider_Concrete_DbProviderService.php'))), $this->getEnv('APP_SECRET'), 'main', array('remember_me_parameter' => 'login[remember_me]', 'lifetime' => 604800, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()));
